...
export function cardMediaRatio(game: GameId, resourceType: ResourceTypeId): CardMediaRatio {
  if (resourceType === "jacket") {
    const jacketRatios: Record<GameId, CardMediaRatio> = { arcaea: "square", phigros: "wide", rizline: "square", infalsus: "square", rotaeno: "square", "paradigm-reboot": "square", orzmic: "wide" };
