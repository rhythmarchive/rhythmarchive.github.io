...
- Chart metadata scope: the APK-local Journey map bundles expose 58 songs and 242 StandardChartDataSO rows (I/II/III/IV plus explicit IV_Alpha variants), including v2InnerDifficulty ratings and chart designers. The encrypted chart bodies, note data, and the remaining songs whose charts are remote are not exported; unmatched public jackets remain marked unavailable.
